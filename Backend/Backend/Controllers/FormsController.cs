        ...
        public IActionResult GetDynamicForms()
        {
            var dynamicForms = new List<DynamicForm>
            {
                ...
                new DynamicForm
                {
                    ...
                    ValidValues = new List<ValidValues>
                    {
                        new ValidValues { Value = "PLNSUP", Description = "PLNSUP", Status = "STATUS1" },
                        new ValidValues { Value = "PLNSUP2", Description = "PLNSUP2",  Status = "STATUS2" },
                        new ValidValues { Value = "PLNSUP3", Description = "PLNSUP3",  Status = "STATUS3" },
                    }
                },
                #endregion
                #region Row2
